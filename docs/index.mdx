...
<Columns cols={3}>
  <Card title="Personal AI Assistant" icon="user" href="/USE_CASES">
    Remember preferences, past conversations, and project context.
  </Card>
  <Card title="Customer Support Agent" icon="headphones" href="/USE_CASES">
    Never ask a customer the same question twice.
  </Card>
  <Card title="Research Agent" icon="book-open" href="/USE_CASES">
...
<Columns cols={2}>
  ...
  <Card title="Use Cases" icon="layers" href="/USE_CASES">
    Personal assistant, support agent, research.
  </Card>
